...
<div class="grid grid-flow-row place-content-between h-full">
    <div out:fade>
        <div
            class="text-4xl text-center bg-nature text-white font-bold grid place-content-center {interacted ? "h-40" : "h-80"} transition-all animate-cheer"
        >
    ...
    <div in:fade class="grid grid-flow-row p-8 h-full">
        ...
        <div>
            ...
            <Actions>
                <button class="relative z-10 action-button max-w-full text-center  ring-offset-2 bg-heart text-white text-2xl shadow-2xl" on:click={(_) => selectFollowupOption()}> Weiter </button>  
    ...
    {:else}
    <div class="text-white bg-nature rounded-full px-24 mx-24 py-2 text-center animate-cheer animation-delay-2000 opacity-0">Danke das du mitgespielt hast</div>


    <div class="grid place-content-center  py-8 mb-16 relative animation-delay-4000 animate-cheer opacity-0">
       ...
       <div class="relative">
           <div class="z-1 animate-blob opacity-60 absolute mix-blend-multiply filter blur-2xl -top-24 -left-36 w-56 h-56 bg-heart-light rounded-full"/>
           ...
           <button class="relative z-10 action-button max-w-full text-center ring-heart-dark ring-2 ring-offset-2 bg-heart text-white text-2xl shadow-2xl" on:click={(_) => selectFollowupOption()}> Weiter </button>  
