...
<div
  ...
  <div class="md:p-8 p-2 grid grid-flow-row gap-4 challenges">
    <div>
      <ChallengeButton
        challenge={{ id: 'oekostrom', text: 'Zu zertifizertem Ökostrom wechseln', options: [{ option: 'Ich wechsel in 2 Wochen', delay: 14 }, { option: 'Ich wechsel in 4 Wochen', delay: 28 }, { option: 'Ich wechsel in 2 Monaten', delay: 60 }] }}>
    ...
    <div>
      <ChallengeButton
        challenge={{ id: 'bike', text: 'Mit dem Rad zur arbeit', options: [{ option: 'Ich probiere es für eine Woche', delay: 7 }, { option: 'Ich probiere es für zwei Wochen', delay: 14 }, { option: 'Ich probiere es für vier Wochen', delay: 28 }] }}>
        <div slot="explanation">
          Ich fahre die nächsten Wochen mit dem Fahrrad zur Arbeit, statt mit
          dem Auto
        </div>
      </ChallengeButton>
    </div>
    ...
    <div>
      <ChallengeButton
        challenge={{ id: 'wlist', text: 'Wunschliste führen', options: [{ option: 'Ich probiere es für eine Woche', delay: 7 }, { option: 'Ich probiere es für zwei Wochen', delay: 14 }, { option: 'Ich probiere es für vier Wochen', delay: 28 }] }}>
        <div slot="explanation">
          Ich führe die nächsten Wochen eine Wunschliste und kaufe nur Dinge,
          die mindestens einen Tag auf der Wunschliste gestanden haben
        </div>
      </ChallengeButton>
    </div>
  </div>
